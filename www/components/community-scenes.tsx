...
const CommunityScenesSkeleton = ({ isMinified }: { isMinified: boolean }) => (
    <div className='container mx-auto overflow-hidden rounded-xl bg-card px-5 py-3 z-10 pb-12'>
        ...
        return (
            <div className='container mx-auto overflow-hidden rounded-xl bg-card px-5 py-3 z-10'>
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-muted-foreground mb-4">Something went wrong while loading community scenes.</p>
