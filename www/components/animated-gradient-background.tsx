...
const AnimatedGradientBackground: React.FC<AnimatedGradientBackgroundProps> = ({
    ...
    Breathing = true,
    gradientColors = [
        "#FF6D00", // Bright orange core
        "#FF4081", // Reddish-pink transition
        "#40C4FF", // Light blue
        "#00E5FF", // Bright cyan edge
        "transparent", // Transparent outer edge
    ],
    gradientStops = [0, 30, 39, 50, 100],
    animationSpeed = 0.02,
    breathingRange = 5,
    containerStyle = {},
    topOffset = 0,
    ...
    useEffect(() => {
        ...
        const animateGradient = () => {
            ...
            const gradient = `radial-gradient(circle at 50% 100%, ${gradientStopsString})`;
