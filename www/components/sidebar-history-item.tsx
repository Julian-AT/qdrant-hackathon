...
const PureSceneItem = ({
    ...
    const { visibilityType, setVisibilityType } = useSceneVisibility({
        sceneId: scene.id,
        initialVisibilityType: scene.visibility,
    });

    return (
        <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={isActive}>
                <Link href={`/scene/${scene.id}`} onClick={() => setOpenMobile(false)}>
...
export const SceneItem = memo(PureSceneItem, (prevProps, nextProps) => {
