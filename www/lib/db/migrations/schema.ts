import { pgTable, foreignKey, uuid, timestamp, text, varchar, json, primaryKey, boolean } from "drizzle-orm/pg-core"
...
export const voteV2 = pgTable("Vote_v2", {
	...
	primaryKey({ columns: [table.sceneId, table.messageId], name: "Vote_v2_sceneId_messageId_pk"}),
]);
...
export const vote = pgTable("Vote", {
	...
	primaryKey({ columns: [table.sceneId, table.messageId], name: "Vote_sceneId_messageId_pk"}),
]);
